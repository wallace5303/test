...
class GenTable {
    ...
    load() {
        this._load('/majiang_ai_normal.txt', this.AITable);
        this._load('/majiang_ai_feng.txt', this.AITableFeng);
        this._load('/majiang_ai_jian.txt', this.AITableJian);
        this._load('/majiang_ai_jian_demo.txt', this.AITableDemo);
    }
